          ...
          {jobs.map((job, index) => (
            ...
            >
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-[7.5px] sm:text-[11px] md:text-sm lg:text-md">
                  {job.tenure}
                </p>
              </div>

              <div className="col-span-3 flex flex-col justify-center items-center border-l border-[rgb(61,61,62)]">
                <h2 className="text-[13px] sm:text-xl lg:text-3xl">
                  {job.title}
                </h2>
                <p className=" mt-2 mx-4 text-justify text-[9px] sm:text-[13px] md:text-sm">
                  {job.jobSummary}
                </p>
              </div>
            </div>
