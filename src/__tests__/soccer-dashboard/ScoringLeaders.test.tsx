...
import ScoringLeaders from "../../app/soccer-dashboard/scoring-leaders/[team_name]/page";
...
describe("<ScoringLeaders />", () => {
  ...
  test("Back button should return to home page", async () => {
    ...
    expect(pushMock).toHaveBeenCalledWith("/soccer-dashboard");
  });
